        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
            ...
            <div className="text-2xl sm:text-3xl md:text-4xl text-slate-600 dark:text-slate-300 mb-8">
              <Typewriter
                options={{
                  strings: ['Full Stack Developer', 'React.js Developer', 'Node.js Developer', 'JavaScript Expert', 'Problem Solver'],
                  autoStart: true,
                  loop: true,
                  delay: 50,
                  deleteSpeed: 30,
      ...
      <section className="py-20 bg-slate-50 dark:bg-slate-800" aria-label="Services Section">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-slate-600 dark:text-slate-400 mt-4">Professional full stack development services</p>
          </motion.div>
                ...
                >
                  ...
                  <div className="relative h-52 overflow-hidden group">
                    {project.image ? (
                      <img
                        src={project.image}
                        alt={`${project.title} – project by Vansh Patel`}
                    ...
                    {project.category && (
                      <span className="absolute top-3 right-3 px-2 py-1 text-xs bg-blue-600 text-white rounded font-medium">
                        {project.category}
                      </span>
                    )}
                  </div>
                  ...
                  <div className="p-6 flex flex-col flex-1">
                    ...
                    <div className="mt-auto pt-4 border-t border-slate-100 dark:border-slate-700 flex items-center gap-6">
                      ...
                      {project.live && project.live !== '#' ? (
                        ...
                        <span className="flex items-center gap-1.5 text-sm font-medium text-slate-300 dark:text-slate-600 cursor-not-allowed">
                          <ExternalLink size={15} /> Live Demo
                        </span>
                      )}
                    </div>
