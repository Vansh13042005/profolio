        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-xl text-blue-600 dark:text-blue-400 mb-6">Software Developer</p>
              <p className="text-slate-600 dark:text-slate-400 leading-relaxed mb-6">
                Passionate Software Developer specializing in Laravel, WordPress, and Custom PHP development. 
                I bridge the gap between complex business requirements and high-performance technical solutions, 
                delivering scalable and secure web applications built for growth.
              </p>
      ...
      <section className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-blue-600 to-purple-600 mx-auto rounded-full" />
            <p className="text-slate-600 dark:text-slate-400 mt-4">Professional services tailored to your needs</p>
          </motion.div>
